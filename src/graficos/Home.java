...
public class Home extends javax.swing.JFrame {
    ...
    public void populate() {
        ...
        for (int i = 0; i < 4; i++) {
            try {
                Patrocinador p = new Patrocinador("Pepito", numero * 10);
                addEscenario(new Escenario(numero, presupuesto, p, null, null));
    ...
    public void addEscenario(Escenario nuevo) {
        boolean creado = false;
        ...
        if (escenarios != null) {
            if (escenarios.getNumero() < 5) {
                while (e != null) {
                    ...
                    if (id == idNuevo) {
                        throw new RuntimeException("Error, dos escenarios no pueden tener el mismo patrocinador");
                    }
                    e = e.getLink();
                }
                ...
                throw new RuntimeException("Error, no se pueden crear más de 5 escenarios");
            }
        } else {
            creado = true;
            escenarios = nuevo;
    ...
    **/
    ...
    private Escenario copiarEscenario(Escenario e) {
        Escenario copia = new Escenario(e.getNumero(), e.getPresupuestoInicial(), e.getPatrocinador(), null, null);

        return copia;
    }

    private Escenario buscarBanda(String nombre) {
        Escenario e = escenarios;
        Escenario listaEscenarios = null;
        Escenario aux2 = null;
        ...
        while (e != null) {
            ...
            if (listaEncontradas != null) {
                if (listaEscenarios == null) {
                    listaEscenarios = copiarEscenario(e);
                    listaEscenarios.setBandas(listaEncontradas);
                    aux2 = listaEscenarios;
                } else {
                    aux2.setLink(copiarEscenario(e));
                    aux2 = aux2.getLink();
                    aux2.setBandas(listaEncontradas);
                }
            }

            listaEncontradas = null;
            e = e.getLink();
        }
    ...
    private void initComponents() {
        ...
        patro = new javax.swing.JButton();
        buscar = new javax.swing.JButton();
        costo = new javax.swing.JButton();
        jLabel13 = new javax.swing.JLabel();
        presupuestoEscenario = new javax.swing.JLabel();
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 290, 261, 150));

        jScrollPane2.setViewportView(bandasL);

        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 290, 250, 150));
        ...
        getContentPane().add(agregarE, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 200, -1, -1));
        ...
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 90, 132, -1));

        jLabel9.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel9.setText("Cantidad de Canciones:");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 150, 129, -1));

        jLabel10.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel10.setText("Precio de la Banda:");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 120, 132, -1));

        jLabel11.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel11.setText("Número de fans:");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 180, 129, -1));
        ...
        getContentPane().add(nomBanda, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 90, 77, -1));
        ...
        getContentPane().add(canciones, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 150, 77, -1));
        ...
        getContentPane().add(precioB, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 120, 77, -1));
        ...
        getContentPane().add(fans, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 180, 77, -1));
        ...
        getContentPane().add(agregarB, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 210, -1, -1));

        patro.setBackground(new java.awt.Color(255, 255, 255));
        patro.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        patro.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagen/buscar.png"))); // NOI18N
        patro.setText("Mostrar patrocinador");
        patro.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                patroActionPerformed(evt);
            }
        });
        getContentPane().add(patro, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 400, 170, 40));
        ...
        getContentPane().add(costo, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 350, 170, -1));

        jLabel13.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Presupuesto Actual: ");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 260, -1, -1));

        presupuestoEscenario.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        presupuestoEscenario.setForeground(new java.awt.Color(255, 255, 255));
        presupuestoEscenario.setText("$0");
        getContentPane().add(presupuestoEscenario, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 260, -1, -1));
    ...
    private void agregarBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarBActionPerformed
        if (!nomBanda.getText().isEmpty() && !precioB.getText().isEmpty() && !canciones.getText().isEmpty() && !fans.getText().isEmpty()) {
            ...
            try {
                ...
                presupuestoEscenario.setText("$" + escenario.getPresupuestoActual());
    ...
    private void agregarEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarEActionPerformed
        ...
        if (!nomPatrocinador.getText().isEmpty() && !presupuestoP.getText().isEmpty() && !idP.getText().isEmpty()) {
            ...
            if (escenarios == null) {
                try {
                    addEscenario(new Escenario(1, pre, p, null, null));
                ...
                try {
                    addEscenario(new Escenario(escenarios.getNumero() + 1, pre, p, null, null));
                    JOptionPane.showMessageDialog(null, "Escenario creado exitosamente");
                    actualizarEscenarios();
                } catch (Exception e) {
                    JOptionPane.showMessageDialog(null, e.getMessage(), "ERROR", 0);
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        if (!nomBanda.getText().isEmpty()) {
            Escenario e = buscarBanda(nomBanda.getText());
            DefaultListModel model = new DefaultListModel();
            model.clear();
            ...
            if (e == null) {
                ...
                while (e != null) {
                    Banda b = e.getBandas();
                    while (b != null) {
                        model.addElement(b.getNombre() + ", " + b.getNumFans() + " fans, " + b.getNumCanciones() + " canciones" + ", Escenario #" + e.getNumero());
                        b = b.getLink();
                    }
                    e = e.getLink();
                }
    ...
    **/
    private void escenariosLValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_escenariosLValueChanged
        ...
        presupuestoEscenario.setText("$" + e.getPresupuestoActual());
        actualizarBandas(e);
    }//GEN-LAST:event_escenariosLValueChanged

    private void patroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_patroActionPerformed
        /*
        n es el número del escenario pero no cambia cuando selecciono otro patrocinador/escenario
         */

        Escenario e = getEscenarioSeleccionado();
        int n = e.getNumero();
        int id = e.getPatrocinador().getIdentificacion();
        String nombre = e.getPatrocinador().getNombre();
        JOptionPane.showMessageDialog(null, "El nombre del Patrocinador del escenario #" + n + " es :" + nombre + "\n Su identificación es:"
                + id, "Patrocinador", 1);
    }//GEN-LAST:event_patroActionPerformed
    ...
    private javax.swing.JButton patro;
    private javax.swing.JTextField precioB;
    private javax.swing.JLabel presupuestoEscenario;
